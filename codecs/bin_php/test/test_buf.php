...
echo "   -- UTF8\n";
test\step( ! $iter->next(), "iterating to EOF must return false");
test\step( $iter->write( 41, "The utf8 äöüš", "UTF8") == 17, "writing of utf8 failed" );
...
test\step( $iter->write( 40, "äöüš second", "UTF8"), "overwriting blob with utf8 failed" );
...
//echo bin2hex( substr( $iter->message(), $iter->idx(), 30) ) . "\n";
test\step( $iter->go_to_tag(41), "finding UTF8 item failed");
test\step( $iter->erase(), "erasing of UTF8 item failed" );
